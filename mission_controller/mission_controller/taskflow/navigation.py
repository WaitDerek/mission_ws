"""Navigation gateway protocol and deterministic test adapters."""
...
class DisabledNavigationGateway:
    def navigate(self, request, cancel_requested) -> NavigationResult:
        del cancel_requested
        return NavigationResult(
            False,
            "unavailable",
            f"navigation unavailable; point {request.point_id} was not sent",
        )
